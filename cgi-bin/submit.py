...
def colIdf(cecid,sheetId):
        ...
        return colIds
# to updatre the local copy and sync with server copy
...
# Checl the date and cecid availability
...
# verify the update meet the pre-requisites
